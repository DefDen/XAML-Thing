...
namespace IndependentProject.Models
{
    ...
    public class MusicIdPrimaryGenres
    {
        public List<MusicGenreList> music_genre_list { get; set; }
    }

    public class MusicIdTrack
    {
    ...
    public class MusicIdBody
    {
        public MusicIdTrack track { get; set; }
    }

    public class MusicIdMessage
    {
        public MusicIdHeader header { get; set; }
        public MusicIdBody body { get; set; }
    }

    public class MusicFromIdRootObject
    {
        public MusicIdMessage message { get; set; }
    }
}
